...
def sendEmail(to, content):
    ...
    server.ehlo()
    server.starttls()
    server.login('brajeshkumar2k1@gmail.com', 'Appleah')
...
if _name_ == "_main_":
    ...
    #logic for executing tasks based on query
        ...
        if 'open youtube' in query:
            ...
            speak("I have been created by Brajesh.")
            ...
            speak("Thanks to Brajesh. further It's a secret")
            ...
            speak("I was created as a Minor project by Mister Brajesh ")
